...
game:IsLoaded()then game.Loaded:Wait()task.wait(5)end local e=a:WaitForChild(
...
end local f=(syn and syn.queue_on_teleport)or syn.queue_on_teleport if f then f(
'loadstring(game:HttpGet("'..b..'loadstring.lua"))()')end
