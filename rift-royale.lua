--[[
	...
	Modified for a smoother aimbot
]]
...
local function checkVisible(v)
	local hit = Camera:GetPartsObscuringTarget(
		{ Camera.CFrame.Position, v.Head.Position },
		{ Camera.CameraSubject.Parent }
	)
...
local function getPlayerHealth(rig)
	...
	if plr then
		return plr:GetAttribute("health") + plr:GetAttribute("shield"),
			plr:GetAttribute("maxHealth") + plr:GetAttribute("maxShield"),
			plr:GetAttribute("maxHealth"),
			plr:GetAttribute("maxShield"),
			plr:GetAttribute("displayName"),
			plr:GetAttribute("dead")
	end
end
...
local function ConstructUI()
	...
	Cache.UI.MainFrameTextFrame.Size =
		Vector2.new(Camera.ViewportSize.X / 8 - 3, (Camera.ViewportSize.Y / 2 - 200) / 20)
	...
	Cache.UI.Credits.Position =
		Vector2.new(1, Camera.ViewportSize.Y / 2 - 200 - ((Camera.ViewportSize.Y / 2 - 200) / 20) * 2)
	...
	Cache.UI.Credits2.Position =
		Vector2.new(1, Camera.ViewportSize.Y / 2 - 200 - (Camera.ViewportSize.Y / 2 - 200) / 20)
	...
	for i = 1, 19 do
		...
		Cache.UI["ESPFrame" .. i].Size =
			Vector2.new(Camera.ViewportSize.X / 8 - 3, (Camera.ViewportSize.Y / 2 - 200) / 20)
		Cache.UI["ESPFrame" .. i].Position =
			Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * i)))
	end
	...
	Cache.UI.ESPButton.Position =
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 1)))
	if Cache.Enabled.ESP then
	...
	Cache.UI.TracersButton.Position =
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 2)))
	if Cache.Enabled.Tracers then
	...
	Cache.UI.Aimbot.Position =
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 3)))
	if Cache.Enabled.Aimbot then
	...
	Cache.UI.AimbotPower.Position =
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 4)))
	...
	Cache.UI.AimbotFOV.Position =
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 5)))
	...
	Cache.UI.ItemESPButton.Position =
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 6)))
	if Cache.Enabled.ItemESP then
	...
	Cache.UI.Nametags.Position =
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 7)))
	if Cache.Enabled.Nametags then
	...
	Cache.UI.AimbotVis.Position =
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 8)))
	if Cache.Enabled.AimVisCheck then
	...
	Cache.UI.ESPVis.Position =
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 9)))
	if Cache.Enabled.ESPVisCheck then
	...
	Cache.UI.ToggleUIButton.Position =
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 18)))
	...
	Cache.UI.ExitButton.Position =
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 19)))
	...
	Cache.UI.Selected.Position =
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * Cache.Selected)))
end
...
Cache.Connections.MouseDown = Mouse.Button1Down:Connect(function()
	local hoveringESP = checkInRange(
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 1)) - 35),
		Vector2.new(Camera.ViewportSize.X / 8 - 3, (Camera.ViewportSize.Y / 2 - 200) / 20)
	)
	if hoveringESP then
		if Cache.Enabled.ESP then
	...
	local hoveringTracers = checkInRange(
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 2)) - 35),
		Vector2.new(Camera.ViewportSize.X / 8 - 3, (Camera.ViewportSize.Y / 2 - 200) / 20)
	)
	...
	local hoveringAimbot = checkInRange(
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 3)) - 35),
		Vector2.new(Camera.ViewportSize.X / 8 - 3, (Camera.ViewportSize.Y / 2 - 200) / 20)
	)
	...
	local hoveringAimbotFOV = checkInRange(
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 5)) - 35),
		Vector2.new(Camera.ViewportSize.X / 8 - 3, (Camera.ViewportSize.Y / 2 - 200) / 20)
	)
	...
	local hoveringAimbotPower = checkInRange(
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 4)) - 35),
		Vector2.new(Camera.ViewportSize.X / 8 - 3, (Camera.ViewportSize.Y / 2 - 200) / 20)
	)
	...
	local hoveringItemESP = checkInRange(
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 6)) - 35),
		Vector2.new(Camera.ViewportSize.X / 8 - 3, (Camera.ViewportSize.Y / 2 - 200) / 20)
	)
	...
	local hoveringNameESP = checkInRange(
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 7)) - 35),
		Vector2.new(Camera.ViewportSize.X / 8 - 3, (Camera.ViewportSize.Y / 2 - 200) / 20)
	)
	...
	local hoveringAimbotVis = checkInRange(
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 8)) - 35),
		Vector2.new(Camera.ViewportSize.X / 8 - 3, (Camera.ViewportSize.Y / 2 - 200) / 20)
	)
	...
	local hoveringESPVis = checkInRange(
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 9)) - 35),
		Vector2.new(Camera.ViewportSize.X / 8 - 3, (Camera.ViewportSize.Y / 2 - 200) / 20)
	)
	...
	local hoveringExit = checkInRange(
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 19)) - 35),
		Vector2.new(Camera.ViewportSize.X / 8 - 3, (Camera.ViewportSize.Y / 2 - 200) / 20)
	)
	...
	local hoveringKeybind = checkInRange(
		Vector2.new(0, Camera.ViewportSize.Y / 2 - (200 - (((Camera.ViewportSize.Y / 2 - 200) / 20) * 18)) - 35),
		Vector2.new(Camera.ViewportSize.X / 8 - 3, (Camera.ViewportSize.Y / 2 - 200) / 20)
	)
...
Cache.Connections.InputBegin = UserInputService.InputBegan:Connect(function(input)
	...
	if input.UserInputType == Enum.UserInputType.MouseButton2 then
		if game.PlaceId == 9611595239 or not Cache.Enabled.Aimbot then
			return
		end
		repeat
...
local function update()
	for rig, drawings in pairs(Cache.Players) do
		...
		if friendly(rig) then
			ESPBox.Color = Color3.new(0.831372, 0, 1)
			ESPTracers.Color = Color3.new(0.831372, 0, 1)
			ESPName.Color = Color3.new(0.831372, 0, 1)
		else
		...
		ESPBox.Visible = visible
			and Cache.Enabled.ESP
			and (checkVisible(rig) or not Cache.Enabled.ESPVisCheck)
			and not dead
		ESPTracers.Visible = visible
			and Cache.Enabled.Tracers
			and (checkVisible(rig) or not Cache.Enabled.ESPVisCheck)
			and not dead
		ESPName.Visible = visible
			and Cache.Enabled.Nametags
			and (checkVisible(rig) or not Cache.Enabled.ESPVisCheck)
			and not dead
		if visible then
			...
			ESPTracers.From =
				Vector2.new(math.floor(Camera.ViewportSize.X * 0.5), math.floor((Camera.ViewportSize.Y / 4) * 3))
...
local function update2()
	for part, draws in pairs(Cache.Items) do
		...
		if
			not part:FindFirstChild("Model")
			and not part:FindFirstChild("Handle")
			and (part:FindFirstChild("Model") and not part.Model:FindFirstChild("Handle"))
		then
			Box.Visible = false
			Text.Visible = false
		end
		...
		elseif
			part:GetAttribute("itemType") == "ak_5"
			or part:GetAttribute("itemType") == "deagle_5"
			or part:GetAttribute("itemType") == "barrett_5"
		then
		...
		if
			not (
				part:GetAttribute("itemType") == "barrett_5"
				or part:GetAttribute("itemType") == "ak_4"
				or part:GetAttribute("itemType") == "ak_5"
				or part:GetAttribute("itemType") == "heavy_armor"
				or part:GetAttribute("itemType") == "deagle_5"
				or part:GetAttribute("itemType") == "launch_pad"
			)
		then
			Box.Visible = false
			Text.Visible = false
